...
var render = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(to, from, next) {
    ...
    var nextCalled, _next, Components, layout, _layout, isValid, _layout2;
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _next = function _next(path) {
              ...
              nextCalled = true;
              _lastPaths = (0, _utils.getMatchedComponents)(from).map(function (Component, i) {
                return (0, _utils.compile)(from.matched[i].path)(from.params);
              });
              next(path);
            };
